...
def test_simple_replicators():
    ...
    dummy_protocol_list_value.values = ProtocolPath('output_value', dummy_replicated_protocol.id)
    ...
    assert dummy_workflow.protocols['dummy_0'].input_value == replicator.template_values[0]
    assert dummy_workflow.protocols['dummy_1'].input_value == replicator.template_values[1]

    assert dummy_workflow.protocols['dummy_single_0'].input_value == ProtocolPath('output_value', 'dummy_0')
    assert dummy_workflow.protocols['dummy_single_1'].input_value == ProtocolPath('output_value', 'dummy_1')

    assert len(dummy_workflow.protocols['dummy_list'].values) == 2

    assert dummy_workflow.protocols['dummy_list'].values[0] == ProtocolPath('output_value', 'dummy_0')
    assert dummy_workflow.protocols['dummy_list'].values[1] == ProtocolPath('output_value', 'dummy_1')
