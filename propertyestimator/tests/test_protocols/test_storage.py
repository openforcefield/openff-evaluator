...
from propertyestimator.protocols.storage import UnpackStoredSimulationData, UnpackStoredDataCollection
from propertyestimator.storage.dataclasses import StoredDataCollection
from propertyestimator.tests.utils import create_dummy_substance, \
    create_dummy_stored_simulation_data, build_tip3p_smirnoff_force_field
...
def test_unpack_stored_simulation_data():
    ...
    with tempfile.TemporaryDirectory() as directory:
        ...
        data_object = create_dummy_stored_simulation_data(directory_path=dummy_directory_path,
        ...
        unpack_stored_data.simulation_data_path = (dummy_data_path, dummy_directory_path, force_field_path)
...
def test_unpack_stored_data_collection():
    ...
    with tempfile.TemporaryDirectory() as directory:
        ...
        unpack_data_collection.input_data_path = (dummy_data_path, data_collection_directory, force_field_path)
