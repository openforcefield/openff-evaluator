...
from propertyestimator.substances import Substance, ExactAmount
    ...
    def _match_substance(self, data_object):
        ...
        if self.substance_query.components_only:
            ...
            for component in self.substance.components:
                ...
                data_amount = next(iter(data_substance.get_amounts(component.identifier)))
                query_amount = next(iter(self.substance.get_amounts(component.identifier)))
