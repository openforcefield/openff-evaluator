...
import propertyestimator.estimator.utils
from propertyestimator.estimator.workflow.schema import CalculationSchema
from propertyestimator.estimator.layers import register_calculation_layer, PropertyCalculationLayer
from propertyestimator.estimator.storage import StoredSimulationData
...
class DirectCalculationGraph:
    ...
    def _execute_protocol(directory, protocol_schema, *parent_outputs, available_resources, **kwargs):
        ...
        for parent_id, parent_output in parent_outputs:
            ...
            if isinstance(parent_output, propertyestimator.estimator.utils.PropertyEstimatorException):
    ...
    def _gather_results(property_to_return, value_reference, uncertainty_reference,
        ...
        for protocol_id, protocol_results in protocol_results:
            ...
            # and uncertainty.
            if isinstance(protocol_results, propertyestimator.estimator.utils.PropertyEstimatorException):
