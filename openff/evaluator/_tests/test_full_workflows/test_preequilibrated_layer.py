...
class TestPreequilibratedSimulationLayer:
    ...
    def _base_test_metadata(self, dummy_enthalpy_of_mixing, directory_name):
        ...
        assert metadata["thermodynamic_state"] == dummy_enthalpy_of_mixing.thermodynamic_state
    ...
    def test_metadata_generation_from_stored(self, dummy_enthalpy_of_mixing, dhmix_density_CCCO):
