"""
Units tests for evaluator.utils.statistics
"""
import os
...
from evaluator.utils.statistics import ObservableType, StatisticsArray, bootstrap
...
def test_bootstrap():
    ...
    value, uncertainty = bootstrap(
        bootstrap_function, 5, 1.0, np.array([2, 3, 4]), values=simple_sub_data
    )
    ...
    value, uncertainty = bootstrap(
        bootstrap_function, 5, 1.0, np.array([2, 3, 4]), values=vector_sub_data
    )
