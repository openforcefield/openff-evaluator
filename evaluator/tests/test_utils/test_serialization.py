"""
Units tests for evaluator.utils.serialization
"""
import json
...
from evaluator.utils.serialization import (
    TypedBaseModel,
    TypedJSONDecoder,
    TypedJSONEncoder,
...
def test_type_string_to_object():
    ...
    client_class = _type_string_to_object("evaluator.client.EvaluatorClient")
    assert client_class == EvaluatorClient

    nested_class = _type_string_to_object(
        "evaluator.client.EvaluatorClient._Submission"
    )
...
def test_type_to_type_string():
    ...
    assert client_string == "evaluator.client.client.EvaluatorClient"

    nested_string = _type_to_type_string(EvaluatorClient._Submission)
    assert nested_string == "evaluator.client.client.EvaluatorClient._Submission"
