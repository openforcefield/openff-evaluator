"""
Units tests for evaluator.layers.simulation
"""

from evaluator import unit
from evaluator.properties.density import Density
from evaluator.protocols.groups import ProtocolGroup
from evaluator.protocols.miscellaneous import AddValues
from evaluator.tests.test_workflow.utils import (
    DummyInputOutputProtocol,
    DummyReplicableProtocol,
)
from evaluator.tests.utils import create_dummy_property
from evaluator.workflow import Workflow, WorkflowSchema
