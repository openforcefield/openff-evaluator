"""
Defines the base API for the evaluator storage backend.
"""
import abc
import uuid
...
from evaluator.attributes import Attribute
...
class StorageBackend(abc.ABC):
    """An abstract base representation of how the evaluator will
