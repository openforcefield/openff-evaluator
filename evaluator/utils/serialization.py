...
def _type_string_to_object(type_string):
    ...
    if type_string == "evaluator.unit.Unit":
        return unit.Unit
    if type_string == "evaluator.unit.Quantity":
        return unit.Quantity
    if type_string == "evaluator.unit.Measurement":
...
def _type_to_type_string(object_type):
    ...
    if (
        ...
        return "evaluator.unit.Measurement"
    ...
    if (
        ...
        return "evaluator.unit.Quantity"
...
class TypedJSONEncoder(json.JSONEncoder):
    ...
    def default(self, value_to_serialize):
        ...
        if type_tag == "evaluator.unit.Unit":
            type_to_serialize = unit.Unit
        if type_tag == "evaluator.unit.Quantity":
            type_to_serialize = pint.Quantity
        if type_tag == "evaluator.unit.Measurement":
