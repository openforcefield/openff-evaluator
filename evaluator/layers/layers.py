"""
Defines the base API for defining new evaluator estimation layers.
"""
import abc
import collections
import logging
...
from evaluator.attributes import UNDEFINED, Attribute, AttributeClass, PlaceholderValue
from evaluator.datasets import PhysicalProperty
from evaluator.storage.data import BaseStoredData, StoredSimulationData
