...
def main():
    ...
    setup_server(backend_type=BackendType.LocalGPU, max_number_of_workers=1, port=8000)

    # Request the estimates.
    property_estimator = client.PropertyEstimatorClient(client.ConnectionOptions(server_port=8000))
    ...
    with open('density_simulation.json', 'wb') as file:
    ...
    # Save the result to file.
    with open('density_reweight.json', 'wb') as file:
